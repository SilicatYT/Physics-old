...
# Get the world corner point for when object axis is x
...
scoreboard players operation #Physics.ContactNormal.y Physics = #Physics.ThisObject Physics.Object.Axis.x.y
scoreboard players operation #Physics.ContactNormal.z Physics = #Physics.ThisObject Physics.Object.Axis.x.z
