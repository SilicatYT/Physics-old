...
execute store success score #Physics.InvertValues Physics if score #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.x < #Physics.Projection.Block.WorldAxis.x.Min Physics
execute if score #Physics.InvertValues Physics matches 1 store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 10
execute if score #Physics.InvertValues Physics matches 0 store result storage physics:temp data.NewContact.FeatureB byte 1 store result storage physics:temp data.FeatureB byte 1 run scoreboard players set #Physics.FeatureB Physics 11
...
execute if score #Physics.InvertValues Physics matches 1 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMax.x
execute if score #Physics.InvertValues Physics matches 0 run scoreboard players operation #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.BoundingBoxGlobalMin.x
    ...
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.0.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:0b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.1.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:1b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.2.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:2b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.3.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:3b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.4.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:4b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.5.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:5b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.6.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:6b}
    execute if score #Physics.DeepestProjection Physics = #Physics.ThisObject Physics.Object.CornerPosGlobal.7.x run function physics:zprivate/contact_generation/new_contact/world/world_axis_x/get_corner {Corner:7b}
...
# Calculate Penetration Depth, Contact Normal, Contact Point & Separating Velocity
    ...
    execute if score #Physics.InvertValues Physics matches 0 run data modify storage physics:temp data.NewContact.ContactNormal set value [I;1000,0,0]
    execute if score #Physics.InvertValues Physics matches 0 run scoreboard players set #Physics.ContactNormal.x Physics 1000
    ...
    # (Important): Because the static object is now the one with the face, the result of the separating velocity is inverted.
        ...
        execute if score #Physics.InvertValues Physics matches 1 run scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.Constants.-1 Physics
