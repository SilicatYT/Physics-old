...
$scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.OtherObjectCorner$(StartCorner).CrossProductAxis.xy Physics
scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.OtherObjectCenter.CrossProductAxis.xy Physics
...
scoreboard players operation #Physics.ContactNormal.x Physics = #Physics.CrossProductAxis.xy.x Physics
scoreboard players operation #Physics.ContactNormal.y Physics = #Physics.CrossProductAxis.xy.y Physics
scoreboard players operation #Physics.ContactNormal.z Physics = #Physics.CrossProductAxis.xy.z Physics
