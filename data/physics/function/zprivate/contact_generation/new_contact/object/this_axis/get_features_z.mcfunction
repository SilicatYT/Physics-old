...
# Get the corner point for when ObjectA's axis is z
...
scoreboard players operation #Physics.ContactNormal.y Physics = #Physics.ThisObject Physics.Object.Axis.z.x
scoreboard players operation #Physics.ContactNormal.z Physics = #Physics.ThisObject Physics.Object.Axis.z.x
