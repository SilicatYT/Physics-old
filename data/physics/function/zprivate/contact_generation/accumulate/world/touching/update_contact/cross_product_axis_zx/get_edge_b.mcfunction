...
$scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.BlockCornerBase$(StartCorner).CrossProductAxis.zx Physics
scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.BlockCenter.CrossProductAxis.zx Physics
...
# Check if the contact is valid
    ...
    $execute if score #Physics.PenetrationDepth Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_zx/penetration_depth_negative {Edge:$(Edge)b}
...
# Contact Point
    # Calculate intermediate results (Dot products)
        # D = v * (u - m)
        scoreboard players operation #Physics.Maths.D Physics = #Physics.ThisObject Physics.Object.Axis.x.z
        ...
        scoreboard players operation #Physics.Maths.Value2 Physics *= #Physics.ThisObject Physics.Object.Axis.x.y
        scoreboard players operation #Physics.Maths.D Physics += #Physics.Maths.Value2 Physics

    # Calculate s (On ObjectA's edge)
        # CE - BD
        execute store result score #Physics.Maths.Value1 Physics run scoreboard players operation #Physics.Maths.s Physics = #Physics.ThisObject Physics.Object.Axis.x.z
        ...
        execute store result score #Physics.ContactPoint.y Physics store result score #Physics.ContactPoint.z Physics run scoreboard players operation #Physics.Maths.s Physics /= #Physics.Maths.Value1 Physics
            ...
            $execute if score #Physics.Maths.s Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xx/invalid_contact_point {Edge:$(Edge)b}
            $execute if score #Physics.Maths.s Physics > @s Physics.Object.Dimension.x run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xx/invalid_contact_point {Edge:$(Edge)b}
    ...
    # Calculate t (On ObjectB's edge)
        ...
        scoreboard players operation #Physics.Maths.Value3 Physics /= #Physics.Maths.Value1 Physics
            ...
            # Check if it's invalid
            $execute if score #Physics.Maths.Value3 Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xx/invalid_contact_point {Edge:$(Edge)b}
            ...
            $execute if score #Physics.Maths.Value3 Physics > Physics.MaxRange Physics run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xx/invalid_contact_point {Edge:$(Edge)b}

    # Calculate the contact point (Middle between points on edges A and B)
        # Point on EdgeA
        scoreboard players operation #Physics.Maths.s Physics *= #Physics.ThisObject Physics.Object.Axis.x.x
...
execute if score #Physics.InvertValues Physics matches 0 store result storage physics:temp data.NewContact.ContactNormal[0] int 1 run scoreboard players get #Physics.CrossProductAxis.zx.x Physics
execute if score #Physics.InvertValues Physics matches 0 store result storage physics:temp data.NewContact.ContactNormal[1] int 1 run scoreboard players get #Physics.CrossProductAxis.zx.y Physics
execute if score #Physics.InvertValues Physics matches 1 store result storage physics:temp data.NewContact.ContactNormal[0] int -1 run scoreboard players get #Physics.CrossProductAxis.zx.x Physics
execute if score #Physics.InvertValues Physics matches 1 store result storage physics:temp data.NewContact.ContactNormal[1] int -1 run scoreboard players get #Physics.CrossProductAxis.zx.y Physics
...
# Separating Velocity
    ...
    scoreboard players operation #Physics.VelocityFromAcceleration.y Physics *= #Physics.CrossProductAxis.zx.y Physics
    ...
    scoreboard players operation #Physics.SubtractVector.x Physics *= #Physics.CrossProductAxis.zx.x Physics
    scoreboard players operation #Physics.SubtractVector.y Physics *= #Physics.CrossProductAxis.zx.y Physics
    ...
    scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.CrossProductAxis.zx.x Physics
