...
# Update the contact
    ...
    execute if score #Physics.Contact.FeatureB Physics matches 10 store success storage physics:temp data.NewContact.ContactNormal[0] int -1000 store result storage physics:temp data.NewContact.ContactPoint[0] int 1 store result score #Physics.ContactPoint.x Physics run scoreboard players get #Physics.Projection.Block.WorldAxis.x.Min Physics
    execute if score #Physics.Contact.FeatureB Physics matches 11 store result storage physics:temp data.NewContact.ContactPoint[0] int 1 store result score #Physics.ContactPoint.x Physics run scoreboard players get #Physics.Projection.Block.WorldAxis.x.Max Physics
