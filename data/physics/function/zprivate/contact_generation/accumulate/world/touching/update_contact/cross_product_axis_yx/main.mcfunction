...
# Get the features
    ...
    $function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_yx/get_edge_a with storage physics:temp data.BlockEdge.$(FeatureA)
...
execute if score #Physics.DotProduct Physics matches ..700000 run return 0
    ...
    execute if score #Physics.Contact.FeatureB Physics matches 24 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_yx/get_edge_b {Edge:24b,StartCorner:0b,x:"Min",y:"Min",z:"Min"}
    execute if score #Physics.Contact.FeatureB Physics matches 25 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_yx/get_edge_b {Edge:25b,StartCorner:1b,x:"Min",y:"Min",z:"Max"}
    execute if score #Physics.Contact.FeatureB Physics matches 26 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_yx/get_edge_b {Edge:26b,StartCorner:2b,x:"Max",y:"Min",z:"Min"}
    function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_yx/get_edge_b {Edge:27b,StartCorner:3b,x:"Max",y:"Min",z:"Max"}
