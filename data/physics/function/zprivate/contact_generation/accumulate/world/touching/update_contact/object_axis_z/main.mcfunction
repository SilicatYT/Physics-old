...
# (Important): If the penetration depth is negative or the contact point is not inside the other object, the contact is just appended (so it can still be updated during resolution) without being updated. In that case, the separating velocity data is removed to avoid potential bugs.
    ...
    scoreboard players operation #Physics.DotProduct Physics = #Physics.ThisObject Physics.Object.Axis.z.x
    ...
    scoreboard players operation #Physics.Maths.Value2 Physics = #Physics.ThisObject Physics.Object.Axis.z.z
    ...
    execute if score #Physics.Contact.FeatureA Physics matches 14 run scoreboard players operation #Physics.DotProduct Physics *= #Physics.Constants.-1 Physics
    ...
    $execute if score #Physics.PenetrationDepth Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/object_axis_z/penetration_depth_negative {FeatureB:$(FeatureB)b}
...
execute store result storage physics:temp data.NewContact.PenetrationDepth short 1 run scoreboard players get #Physics.PenetrationDepth Physics
    ...
    $execute if score #Physics.Contact.FeatureA Physics matches 14 run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/object_axis_z/get_corner_negative with storage physics:temp data.BlockCorner[$(FeatureB)]
    $execute if score #Physics.Contact.FeatureA Physics matches 15 run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/object_axis_z/get_corner_positive with storage physics:temp data.BlockCorner[$(FeatureB)]
    ...
    # Separating Velocity
        ...
        scoreboard players operation #Physics.VelocityFromAcceleration.y Physics *= #Physics.ThisObject Physics.Object.Axis.z.y
        ...
        scoreboard players operation #Physics.SubtractVector.x Physics *= #Physics.ThisObject Physics.Object.Axis.z.x
        scoreboard players operation #Physics.SubtractVector.y Physics *= #Physics.ThisObject Physics.Object.Axis.z.y
        scoreboard players operation #Physics.SubtractVector.z Physics *= #Physics.ThisObject Physics.Object.Axis.z.z
        ...
        scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.ThisObject Physics.Object.Axis.z.x
        scoreboard players operation #Physics.PointVelocity.y Physics *= #Physics.ThisObject Physics.Object.Axis.z.y
        scoreboard players operation #Physics.PointVelocity.z Physics *= #Physics.ThisObject Physics.Object.Axis.z.z
        ...
        execute if score #Physics.Contact.FeatureA Physics matches 14 run scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.Constants.-1 Physics
