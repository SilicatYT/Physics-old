...
$scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.BlockCornerBase$(StartCorner).CrossProductAxis.zy Physics
scoreboard players operation #Physics.PenetrationDepth Physics -= #Physics.Projection.BlockCenter.CrossProductAxis.zy Physics
...
# Check if the contact is valid
    ...
    $execute if score #Physics.PenetrationDepth Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_zy/penetration_depth_negative {Edge:$(Edge)b}
...
# Contact Point
    # Calculate intermediate results (Dot products)
        # D = v * (u - m)
        scoreboard players operation #Physics.Maths.D Physics = #Physics.ThisObject Physics.Object.Axis.y.z
    ...
    # Calculate s (On ObjectA's edge)
        # CE - BD
        execute store result score #Physics.Maths.Value1 Physics run scoreboard players operation #Physics.Maths.s Physics = #Physics.ThisObject Physics.Object.Axis.y.z
    ...
    # Calculate t (On ObjectB's edge)
        ...
        scoreboard players operation #Physics.Maths.Value3 Physics /= #Physics.Maths.Value1 Physics
            ...
            # Check if it's invalid
            $execute if score #Physics.Maths.Value3 Physics matches ..-1 run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xy/invalid_contact_point {Edge:$(Edge)b}
            ...
            $execute if score #Physics.Maths.Value3 Physics > Physics.MaxRange Physics run return run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/cross_product_axis_xy/invalid_contact_point {Edge:$(Edge)b}
...
execute if score #Physics.InvertValues Physics matches 0 store result storage physics:temp data.NewContact.ContactNormal[0] int 1 run scoreboard players get #Physics.CrossProductAxis.zy.x Physics
execute if score #Physics.InvertValues Physics matches 0 store result storage physics:temp data.NewContact.ContactNormal[1] int 1 run scoreboard players get #Physics.CrossProductAxis.zy.y Physics
execute if score #Physics.InvertValues Physics matches 1 store result storage physics:temp data.NewContact.ContactNormal[0] int -1 run scoreboard players get #Physics.CrossProductAxis.zy.x Physics
execute if score #Physics.InvertValues Physics matches 1 store result storage physics:temp data.NewContact.ContactNormal[1] int -1 run scoreboard players get #Physics.CrossProductAxis.zy.y Physics
...
# Separating Velocity
    ...
    scoreboard players operation #Physics.VelocityFromAcceleration.y Physics *= #Physics.CrossProductAxis.zy.y Physics
    ...
    scoreboard players operation #Physics.SubtractVector.x Physics *= #Physics.CrossProductAxis.zy.x Physics
    scoreboard players operation #Physics.SubtractVector.y Physics *= #Physics.CrossProductAxis.zy.y Physics
    ...
    scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.CrossProductAxis.zy.x Physics
    scoreboard players operation #Physics.PointVelocity.y Physics *= #Physics.CrossProductAxis.zy.y Physics
