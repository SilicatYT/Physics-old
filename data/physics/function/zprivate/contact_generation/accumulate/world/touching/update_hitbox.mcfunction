...
# Contact 1
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-1].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-1].FeatureB
...
# Contact 2
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-2].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-2].FeatureB
...
# Contact 3
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-3].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-3].FeatureB
...
# Contact 4
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-4].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-4].FeatureB
...
# Contact 5
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-5].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-5].FeatureB
...
# Contact 6
execute store result score #Physics.Contact.FeatureA Physics store result storage physics:temp data.NewContact.FeatureA byte 1 run data get storage physics:temp data.Hitbox.Contacts[-6].FeatureA
execute store result score #Physics.Contact.FeatureB Physics store result storage physics:temp data.NewContact.FeatureB byte 1 run data get storage physics:temp data.Hitbox.Contacts[-6].FeatureB
...
execute unless score #Physics.Contact.FeatureB Physics = #Physics.FeatureB Physics run function physics:zprivate/contact_generation/accumulate/world/touching/update_contact/main {Index:-6b}
