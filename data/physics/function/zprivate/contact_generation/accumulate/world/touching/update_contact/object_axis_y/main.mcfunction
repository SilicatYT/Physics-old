...
# (Important): If the penetration depth is negative or the contact point is not inside the other object, the contact is just appended (so it can still be updated during resolution) without being updated. In that case, the separating velocity data is removed to avoid potential bugs.
    ...
    scoreboard players operation #Physics.DotProduct Physics = #Physics.ThisObject Physics.Object.Axis.y.x
    ...
    scoreboard players operation #Physics.Maths.Value2 Physics = #Physics.ThisObject Physics.Object.Axis.y.z
...
execute store result storage physics:temp data.NewContact.PenetrationDepth short 1 run scoreboard players get #Physics.PenetrationDepth Physics
    ...
    # Separating Velocity
        ...
        scoreboard players operation #Physics.VelocityFromAcceleration.y Physics *= #Physics.ThisObject Physics.Object.Axis.y.y
        ...
        scoreboard players operation #Physics.SubtractVector.x Physics *= #Physics.ThisObject Physics.Object.Axis.y.x
        scoreboard players operation #Physics.SubtractVector.y Physics *= #Physics.ThisObject Physics.Object.Axis.y.y
        scoreboard players operation #Physics.SubtractVector.z Physics *= #Physics.ThisObject Physics.Object.Axis.y.z
        ...
        scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.ThisObject Physics.Object.Axis.y.x
        scoreboard players operation #Physics.PointVelocity.y Physics *= #Physics.ThisObject Physics.Object.Axis.y.y
        scoreboard players operation #Physics.PointVelocity.z Physics *= #Physics.ThisObject Physics.Object.Axis.y.z
        ...
        execute if score #Physics.Contact.FeatureA Physics matches 12 run scoreboard players operation #Physics.PointVelocity.x Physics *= #Physics.Constants.-1 Physics
