...
$execute store result score #Physics.ContactVelocityChange.z Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[2].ContactPoint[1]
...
$execute store result storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[2].SeparatingVelocity short 1 run scoreboard players operation #Physics.ContactNormal.x Physics /= #Physics.Constants.1000 Physics
...
$execute store result storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[2].HasMinSeparatingVelocity byte 0 run data remove storage physics:resolution Object.Objects[0].Blocks[].Hitboxes[].Contacts[].HasMinSeparatingVelocity
