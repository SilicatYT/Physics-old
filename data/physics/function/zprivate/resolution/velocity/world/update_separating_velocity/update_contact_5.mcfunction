...
$execute store result score #Physics.ContactVelocity.x Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[0]
$execute store result score #Physics.ContactVelocity.y Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[1]
$execute store result score #Physics.ContactVelocity.z Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[2]
$execute store result storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[0] int 1 run scoreboard players operation #Physics.ContactVelocity.x Physics += #Physics.ContactVelocityChange.x Physics
$execute store result storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[1] int 1 run scoreboard players operation #Physics.ContactVelocity.y Physics += #Physics.ContactVelocityChange.y Physics
$execute store result storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactVelocity[2] int 1 run scoreboard players operation #Physics.ContactVelocity.z Physics += #Physics.ContactVelocityChange.z Physics

# Update SeparatingVelocity
$execute store result score #Physics.ContactNormal.x Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactNormal[0]
$execute store result score #Physics.ContactNormal.y Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactNormal[1]
$execute store result score #Physics.ContactNormal.z Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[5].ContactNormal[2]
