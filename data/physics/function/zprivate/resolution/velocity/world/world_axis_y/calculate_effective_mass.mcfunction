...
# (Important): For world_axis_?, the effective mass calculations are scaled up just enough so that InverseMass can be added to it without needing to scale it down. The calculations don't overflow for reasonable numbers. The scaling is different from non-axis-aligned contact normals.
    ...
    execute store result score #Physics.Maths.a3.y Physics store result score #Physics.Maths.a2.z Physics run scoreboard players operation #Physics.Maths.RelativeContactPos.x Physics -= @s Physics.Object.Pos.x
    ...
    execute store result score #Physics.Maths.a2.x Physics store result score #Physics.Maths.b1.z Physics store result score #Physics.Maths.b1.y Physics store result score #Physics.Maths.a1.y Physics run scoreboard players operation #Physics.Maths.RelativeContactPos.z Physics -= @s Physics.Object.Pos.z

    # Axis 1: Tangent 1 [1.0, 0.0, 0.0]
        ...
        # Scaled up by 1,000x
            ...
            # z-component
            execute store result score #Physics.Maths.Value2 Physics store result score #Physics.Maths.Value1 Physics run scoreboard players operation #Physics.Maths.a1.z Physics *= #Physics.Constants.-1 Physics
    ...
    # Axis 2: ContactNormal [0.0, ±1.0, 0.0]
        # a = RelativeContactPos x Axis
            # x-component
            execute if score #Physics.FeatureB Physics matches 13 run scoreboard players operation #Physics.Maths.a2.x Physics *= #Physics.Constants.-1 Physics
            execute store result score #Physics.Maths.b2.z Physics run scoreboard players operation #Physics.Maths.b2.x Physics = #Physics.Maths.a2.x Physics

            # y-component
            # (Important): It's always 0.

            # z-component
            execute if score #Physics.FeatureB Physics matches 12 run scoreboard players operation #Physics.Maths.a2.z Physics *= #Physics.Constants.-1 Physics
            execute store result score #Physics.Maths.Value4 Physics run scoreboard players operation #Physics.Maths.Value3 Physics = #Physics.Maths.a2.z Physics
