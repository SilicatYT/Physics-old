...
$execute store result score #Physics.PenetrationDepthDifference Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[4].ContactNormal[0]
$execute store result score #Physics.Maths.Value1 Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[4].ContactNormal[1]
$execute store result score #Physics.Maths.Value2 Physics run data get storage physics:temp data.UpdateBlocks[-1].Hitboxes[$(Index)].Contacts[4].ContactNormal[2]
